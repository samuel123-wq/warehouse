...
<body>
    ...
    <main class="table" id="customers_table" style="margin-top : 90px;">
        <section class="table__header">
            <button type='bu' onclick='event.preventDefault(); customBack4();'><img src='back.png' style='width: 25px; height: 25px;'></button>
            ...
            <select id="status" name="status"  onchange="this.form.submit()" >
                <option value="1" <?php if ($selected_status == '1') echo 'selected'; ?>>Paid</option>
                <option value="0" <?php if ($selected_status == '0') echo 'selected'; ?>>Haven't Paid</option>
            </select>
